...
<div class="container ">
  ...
  <div class="">
      <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
          <li class=" nav-item" role="presentation">
            <button @class(['nav-link', 'active' => !($errors->has("name") || session()->has("success"))]) clas id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Stream</button>
          </li>
          <li class="nav-item" role="presentation">
            <button @class(['nav-link', 'active' => ($errors->has("name") || session()->has("success"))])  id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Classwork</button>
          </li>
          <li class="nav-item" role="presentation">
  ...
  <div class="row py-5">
      ...
      <div class="tab-content " id="myTabContent">
          <div @class(['tab-pane fade', 'show active' => !($errors->has("name") || session()->has("success"))]) id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
        <div class="row">
  ...
  <div class="col-8">
    ...
    Stream content
          ...
          <div  @class(['tab-pane fade', 'show active' =>($errors->has("name") || session()->has("success"))]) id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
